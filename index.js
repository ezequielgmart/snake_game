...
class Game {
    ...
    detailsDirection = ["", "Up", "Rigth", "Down", "Left"];
    ...
    constructor(txtButton, txtState, canvas) {
        ...
        this.lose.src = './media/game_over.jpg';
    ...
    next() {
        ...
        // esto va mostrando el recorrido de la vibora
    ...
    show() {
        ...
        // using map to navigate the snake array
        this.snake.map((square, index) => {
            if (index == 0) {
                this.ctx.drawImage(this.head, square.X * this.sizeSquare, square.Y * this.sizeSquare)
            } else {
                this.ctx.drawImage(this.tail, square.X * this.sizeSquare, square.Y * this.sizeSquare)
            }

            if (this.food != null) {
                this.ctx.drawImage(this.cookie, this.food.X * this.sizeSquare, this.food.Y * this.sizeSquare)
    ...
    getFood() {
        // random positions will show food
        let square = new Object();
    ...
    printDirection() {
        this.txtState.value = this.detailsDirection[this.direction];
    }
...
var game = new Game(document.getElementById('txtButton'), document.getElementById('txtState'), document.getElementById('main_canvas'));
